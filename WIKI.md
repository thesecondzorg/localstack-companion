...
![Active LocalStack AWS Resources Dashboard](docs/images/dashboard_main_view.png)
...
![Pending Requests - Missing Resource Detected](docs/images/pending_actions_view.png)
...
![Interactive Resource Manager - SQS Message Sender](docs/images/sqs_modal_manager.png)
